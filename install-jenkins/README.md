...
# First build and push to repository 
docker build -t ehumanistregistry.azurecr.io/base/jenkins:2.479.1-1 .
docker push ehumanistregistry.azurecr.io/base/jenkins:2.479.1-1

helm upgrade --install  jenkins jenkins -n jenkins --create-namespace
